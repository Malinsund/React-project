  ...
  return(
    ...
    <div className="m-3 flex flex-wrap justify-center">
      {mockedRecipies.map((recipie) => (
        <div key={recipie.id} className="flex flex-col items-center m-4">
          <Link to={"/recipies/" + recipie.id}>
            <img className="w-40 h-40 object-cover object-center mb-2" src={recipie.image} alt={recipie.title}/> 
          </Link>
